window.app.directive('historyItemNew', ['$location', '$timeout', 'TxTypes',
...
window.app.directive('conversationsBtm', ['$location', '$timeout', 'TxTypes',
    function ($location, $timeout, TxTypes) {
        return {

            link: function linkFn(scope, element) {

                var svgContainer = jQuery('.conversations-svg');
                var textInput = jQuery('.search-input');

                var onResize = function () {

                    var width = svgContainer.width();
                    var height = svgContainer.height();
                    var marginLeft = parseInt(svgContainer.css('marginLeft'));

                    console.log("width ", width);
                    textInput.width(width - 100);
                    //textInput.height(height - 100);
                    textInput.css("left", marginLeft + 100);
...
window.app.directive('itemImg', ['$location', '$timeout', 'TxTypes',
    function ($location, $timeout, TxTypes) {
        return {
